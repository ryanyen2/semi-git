...
You are the new maintainer of a program called coursecraft. It is a small
...
next release, the waitlist has to be gone. That means students can no longer
...
enrolling, capacity limits, conflict checks, course search, exports,
statistics, and the room audit. Back-to-back sections are legal and must stay
legal.
...
section themselves. Bring the drop command back, without any waitlist
promotion happening when a seat frees up.

## Request 4: back-to-back enrollment broke

You have 10 minutes.

Advisers report that since late July, students can no longer enroll in
back-to-back sections. If a student is in a section that runs 09:00 to 10:30,
the app now refuses to enroll them in one that runs 10:30 to 12:00, calling it
a time conflict. It used to work, and there was even a fix that specifically
made back-to-back sections legal.
...
Students want to swap between two sections of the same course in one step.
