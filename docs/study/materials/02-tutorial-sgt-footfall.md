...
![The nav and the date window, which every page carries](/stages/footfall-window.png)
...
![The hour-of-day page's weekday and weekend charts, side by side](/stages/footfall-hourly-split.png)
