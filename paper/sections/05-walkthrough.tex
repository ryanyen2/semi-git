...
prints the command a person should type,
\cmd{api.py::handle \ttarrow{} sgt resolve api.py::handle}. Two commands telling
the developer different things to type is an inconsistency we have not cleaned up.
The two
