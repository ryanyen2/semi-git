...
came out of \sgt{} as it is today, with lines too wide for this column wrapped at
the \ttdot{} separators, with two displays too tall for this column replaced by a
description of them in brackets, and otherwise unchanged. The sequence is arranged to show
...
carried on, which is the case Section~\ref{sec:scenarios} opened with.
...
carefully is paying us for a certainty they already had.
