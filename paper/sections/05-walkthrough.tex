...
span of the history holds none of them, so the terminal spends four characters on the
...
We designed for the case where the merge is wrong---one edit adding an early return and
the other edit's new code sitting below it---with the test run that would have caught it
happening on a branch nobody has pushed yet. A developer who merges often and reads
