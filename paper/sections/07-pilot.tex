...
Section~\ref{sec:design} and identified six themes that generalise past the
individual defects.
...
Seven such failures appeared across the full evaluation period,
three of which we had not found after eight months of daily use and
found only by auditing the evaluation's own results.
...
principle~\cite{jackson2021}. The lesson is that internal consistency is a
learnability precondition (not merely cosmetic), and a tool whose surfaces
disagree teaches the user to ignore its numbers.
